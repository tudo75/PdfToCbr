...
namespace PdfToCbr {
    ...
    public class ExtractorWindow : Gtk.ApplicationWindow {
        ...
        /**
         * Open Gtk.FileDialog to select a PDF file.
         * 
         * @since 0.0.1
         */
        ...
        /**
         * Open Gtk.FileDialog to choose the destination folder or the CBZ/CBR archive file.
         * 
         * @since 0.0.1
         */
        ...
        /**
         * Handler for the start extraction button click event.
         * 
         * @since 0.0.1
         */
